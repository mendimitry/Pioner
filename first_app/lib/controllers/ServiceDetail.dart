...
Future<List<Map<String, dynamic>>> getAllServiceDetail() async{
  ...
  for (var element in query) {
    _address={'nameService': element['service_detail']['service_detail_name'], 'value': element['service_detail']['service_detail_cost'],'timeValue': element['service_detail']['service_detail_cost']};
    print(_address);
