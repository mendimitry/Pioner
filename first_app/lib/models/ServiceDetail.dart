class ServiceDetail{
  ...
  String servoce_detail_name;
  int service_detail_cost;
  int service_detail_duration;
  String? add_info;

  ServiceDetail({required this.service_detail_id, required this.type_id, required this.service_detail_code, required this.servoce_detail_name, required this.service_detail_cost,
  ...
  factory ServiceDetail.fromReqBody(Map<String, dynamic> json){
    return ServiceDetail(
      ...
      servoce_detail_name:json['service_detail_name'] as String,
  ...
  void printAttributes() {
    ...
    print ("servoce_detail_name: ${this.servoce_detail_name}");
