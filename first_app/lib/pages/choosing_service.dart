  ...
  Widget build(BuildContext context) {
    return Scaffold(
        body: Padding(
          ...
          Text('Услуги', style: TextStyle(fontSize: 20),
                  ...
                  setState(() {
                    ...
                    ElevatedButton(onPressed: (){
                      if(_service == services.car_wash){
                        Navigator.push(context, MaterialPageRoute(builder: (context) => ChoosingOrganizationCarWash()));
                      }
                      else
                        Navigator.push(context, MaterialPageRoute(builder: (context) => ChoosingOrganizationTireService()));
                    },style: ElevatedButton.styleFrom(backgroundColor: Colors.black26, fixedSize: Size(300,50)),
                        child: Text('Выбрать услугу', style: TextStyle(fontSize: 18, color: Colors.white), textAlign: TextAlign.center)),]),
