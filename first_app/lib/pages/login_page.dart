      ...
      body: Center(
        child: Column (
          children: [
            ...
            ElevatedButton(onPressed: (){Navigator.push(context, MaterialPageRoute(builder: (context) => AutoUserRegister(value: 2)));},style: ElevatedButton.styleFrom(backgroundColor: Colors.black26, fixedSize: Size(300,50)),
                child: Text('Владельцам транспортных средств', style: TextStyle(fontSize: 18, color: Colors.white), textAlign: TextAlign.center)),

            Padding(padding: EdgeInsets.only(top: 50)),
            ElevatedButton(onPressed: (){Navigator.push(context, MaterialPageRoute(builder: (context) => PostListPage()));},style: ElevatedButton.styleFrom(backgroundColor: Colors.black26, fixedSize: Size(300,50)),
                child: Text('Организациям - партнёрам', style: TextStyle(fontSize: 18, color: Colors.white), textAlign: TextAlign.center)),

            Padding(padding: EdgeInsets.only(top: 50)),
            ElevatedButton(onPressed: (){Navigator.push(context, MaterialPageRoute(builder: (context) => TestAdminka()));},style: ElevatedButton.styleFrom(backgroundColor: Colors.black26, fixedSize: Size(300,50)),
